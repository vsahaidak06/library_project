...
-- SELECT l.id, l.customer_id, c.name, l.return_date
--     FROM customer c
--     INNER JOIN customer2loan cl ON c.id = cl.customer_id
--     INNER JOIN loan l ON l.id = cl.loan_id;
...
-- SELECT l.id, l.book_id, b.title, l.return_date
--     FROM book b
--     INNER JOIN book2loan bl ON b.id = bl.book_id
--     INNER JOIN loan l ON l.id = bl.loan_id;
...
-- SELECT b.id, b.author_id, a.name, b.title
--     FROM author a
...
-- SELECT b.id, b.genre_id, g.name, b.title
--     FROM genre g
--     INNER JOIN genre2book gb ON g.id = gb.genre_id
--     INNER JOIN book b ON b.id = gb.book_id;
